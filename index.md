...
carpentry: "hpc"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "University of Alberta"        # brief name of host site without address (e.g., "Euphoric State University")
address: "CCIS L1-150"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "53.528117, -113.525747"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
collaborative_notes: "https://pad.carpentries.org/2018-09-25-ualberta-HPC"             # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p>The workshop is split into three modules, as follows:</p>
<ol>
...
<p>To participate in HPC Carpentry you will need an up-to-date web browser and access to the software described below.
</p>
<p>
